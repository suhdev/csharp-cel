...
namespace Cel.UnitTests.Parser;

/// <summary>
/// Functional tests for <see cref="Cel.Parsing.Parser"/>. Each test asserts the structural shape
...
public sealed class ParserTests
{
    ...
    {
        var r = Cel.Parsing.Parser.Parse(src);
