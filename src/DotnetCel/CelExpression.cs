...
public sealed class CompiledProgram
{
    ...
    internal CompiledProgram(CheckedAst ast, CelEnv env)
    {
        ...
        registry.Bind("equals", args => CelValue.Of(CelEquality.Equals(args[0], args[1], provider)));
        registry.Bind("not_equals", args => CelValue.Of(!CelEquality.Equals(args[0], args[1], provider)));
    ...
    public Types.CelType ResultType => Ast.ResultType;
