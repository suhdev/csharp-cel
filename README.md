...
| `string`, `parse`, `conversions`, `fields` | **80–92%** |
| `comparisons`, `timestamps`, `math_ext` | **52–59%** — wrapper unwrapping, NaN edge cases, time accessors missing |
...
| `network_ext`, `optionals`, `macros2`, `proto2_ext`, `type_deduction`, `unknowns` | **0–17%** — features not yet built |
| **Total** | **1161 / 2263 ran (51%) over 2454 cases (191 skipped)** |
